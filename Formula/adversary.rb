class Adversary < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/doomerlabs/adversary/releases/download/2026.9.15/adversary_2026.9.15_darwin_amd64.tar.gz"
      sha256 "96e3ff5e4d6b8d9ce8a1e23d4b9cdb4a638a367e72472017e6224fa1a8d96311"
    end

    on_arm do
      url "https://github.com/doomerlabs/adversary/releases/download/2026.9.15/adversary_2026.9.15_darwin_arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/doomerlabs/adversary/releases/download/2026.9.15/adversary_2026.9.15_linux_amd64.tar.gz"
      sha256 "bd7a14161bd5c6905fb03f711f837eba0cf905c0f1bfb00ebde05f0c81a316b1"
    end

    on_arm do
      url "https://github.com/doomerlabs/adversary/releases/download/2026.9.15/adversary_2026.9.15_linux_arm64.tar.gz"
